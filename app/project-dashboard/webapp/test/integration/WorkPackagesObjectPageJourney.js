...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("WorkPackagesObjectPageObjectPage journey");

        opaTest("Navigate to WorkPackagesObjectPageObjectPage", function (Given, When, Then) {
            Given.iStartMyApp();
            ...
            Then.onTheProjectsObjectPage.onTable({ property: "WorkPackages" }).iCheckRows();
            When.onTheProjectsObjectPage.onTable({ property: "WorkPackages" }).iPressRow(0);

            Then.onTheWorkPackagesObjectPage.iSeeThisPage();
        });
