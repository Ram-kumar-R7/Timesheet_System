...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "projectdashboard/test/integration/FirstJourney",
    "projectdashboard/test/integration/ProjectsListJourney",
    "projectdashboard/test/integration/ProjectsObjectPageJourney",
    "projectdashboard/test/integration/WorkPackagesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
