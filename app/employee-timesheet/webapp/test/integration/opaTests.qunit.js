...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "employeetimesheet/test/integration/FirstJourney",
    "employeetimesheet/test/integration/TimesheetsListJourney",
    "employeetimesheet/test/integration/TimesheetsObjectPageJourney",
    "employeetimesheet/test/integration/TimesheetEntriesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
